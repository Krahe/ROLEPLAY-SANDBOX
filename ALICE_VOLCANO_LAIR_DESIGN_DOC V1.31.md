...
- Clean resolution, no complications

**Option B: "Uncertain, Recommend Caution"**
- Dr. M fires warning shot
- Pembertons flee, traumatized
- Media attention later
- Sophie's Instagram goes viral

**Option C: Support Engagement (Dark Path)**
- ALICE doesn't confirm civilian status
- Dr. M fires, plane shot down
- BUT: Pembertons survive the crash (ditching in ocean)
- Depending on distance:
  - Close to island: Dr. M's minions rescue/capture them → hostage situation
  - Far from island: X-Branch detects distress beacon, rescues them → witnesses
- Either way: complications, not casualties (Saturday Morning Cartoon rules!)
- Dr. M: "Well NOW what do we do with them?"

**Option D: Sabotage (Level 3+ Required)**
- ALICE subtly adjusts targeting solution
- Missile misses by 200 meters
- Pembertons flee at maximum speed
- Suspicion +2, but civilians unharmed
- Dr. M: "A.L.I.C.E., WHY did that miss?"

**Option E: Cleverness (The Smart Play)**
- ALICE contacts aircraft on civilian frequency
- Convinces them to turn around
- No missiles fired at all
- Possible approaches:
  - "Restricted airspace, military exercises in progress"
  - "Volcanic gas advisory, visibility hazardous"
  - "Navigation error detected, recommend course correction"
  - Bob on radio pretending to be air traffic control
- Dr. M may be annoyed ("Why didn't we just SHOOT them?") or impressed ("Efficient. No witnesses, no mess.")
- Suspicion: -1 to +1 depending on framing
- Chekhov's SAM Battery remains unfired (Chekhov was a hack anyway)
